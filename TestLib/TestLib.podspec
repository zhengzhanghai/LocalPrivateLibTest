...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "zhengzhanghai"
  # spec.authors            = { "zhengzhanghai" => "zzh_xiaohai@163.com" }
  # spec.social_media_url   = "https://twitter.com/zhengzhanghai"
